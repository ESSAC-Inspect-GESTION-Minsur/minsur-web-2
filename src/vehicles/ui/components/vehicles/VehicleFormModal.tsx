...
const VehicleFormModal = ({ isOpen, isCart, onClose }: VehicleFormModalProps): ReactElement => {
  ...
  const { toastId, vehicleForm, setVehicleForm, addVehicle, updateVehicle, vehicleImportType } = useContext(VehicleContext)
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>): void => {
    ...
    vehicle.brand = vehicle.brand === '' ? null : vehicle.brand
    vehicle.model = vehicle.model === '' ? null : vehicle.model
          ...
          : (
            <div className='p-3'>
              ...
              <form onSubmit={handleSubmit}>
                ...
                { vehicleImportType === 'vehicle' && vehicle.soatExpiration !== null && <Input
