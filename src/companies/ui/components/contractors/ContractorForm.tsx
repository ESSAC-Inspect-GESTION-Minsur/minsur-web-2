...
import { type ContractorDto, CONTRACTOR_DTO_INITIAL_STATE } from '@/companies/models/contractor.interface'
import { ContractorsService } from '@/companies/services/contractor.service'
import { ContractorContext } from '../../contexts/ContractorContext'
import { useDataForm } from '@/shared/hooks/useDataForm'
import { formatServiceError } from '@/shared/utils'
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>): void => {
    ...
    void submitAction(contractor, id)
      ...
      .catch(error => {
        ...
        const errors = formatServiceError(message)
